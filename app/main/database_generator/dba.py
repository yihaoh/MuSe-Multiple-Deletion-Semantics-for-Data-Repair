...
class DatabaseEngine():
    ...
    def __init__(self, db_name):
        ...
        try:
            ...
            # cur.execute('SELECT * FROM author WHERE author.aid = 58525;')
            # print('in dba:', cur.fetchall())
    ...
    def load_database_tables(self, lst_names, is_delta=False):
        ...
        for name in lst_names:
            ...
            # file_to_open = os.path.expanduser('~/Desktop/DelSem_demo/' + name + '.csv')
            file_to_open = os.path.expanduser(os.getcwd() + '/app/main/database_generator/' + name + '.csv')
